...
(defun rush-move-key (key-from key-to keymap)
...
(rush-move-key "k" "C-k" magit-file-section-map)
(rush-move-key "k" "C-k" magit-untracked-section-map)
(rush-move-key "k" "C-k" magit-tag-section-map)
(rush-move-key "k" "C-k" magit-stash-section-map)
(rush-move-key "k" "C-k" magit-stashes-section-map)
(rush-move-key "k" "C-k" magit-unstaged-section-map)
(rush-move-key "k" "C-k" magit-hunk-section-map)
(rush-move-key "k" "C-k" magit-branch-section-map)
(rush-move-key "<C-tab>" nil magit-log-mode-map)
(rush-move-key "<C-tab>" nil magit-revision-mode-map)
(rush-move-key "<C-tab>" nil magit-status-mode-map)
...
(rush-move-key "v" nil magit-file-section-map)
(rush-move-key "v" nil magit-hunk-section-map)
...
(defvar rush-magit-commit-nodefun nil)
(define-key magit-status-mode-map "C"
  (lambda ()
    (interactive)
    (setq rush-magit-commit-nodefun t)
...
(setq magit-commit-add-log-insert-function 'rush-magit-commit-add-log-insert)
(defun rush-magit-commit-add-log-insert (buffer file defun)
  (with-current-buffer buffer
    ...
    (cond ((not (re-search-forward (format "^\\* %s" (regexp-quote file))
           ...
           (unless rush-magit-commit-nodefun
             (when defun
               (insert (format " (%s)" defun))))
           (setq rush-magit-commit-nodefun nil)
           (insert ": "))
          (defun
...
;;;###autoload
(defun rush-nextmagit-status-hook ()
  (yas-minor-mode 0))
;;;###autoload
(defun rush-nextmagit-log-hook ())
;;;###autoload
(defun rush-nextmagit-commit-hook ())
;;;###autoload
(defun rush-nextmagit-diff-hook ())
;;;###autoload
(defun rush-nextmagit-branch-manager-hook ())
;;* Functions
