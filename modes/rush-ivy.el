...
(ivy-set-actions
 t
 '(("i" rush-insert "insert")
   ("w" rush-kill-new "copy")))
...
(setq counsel-git-grep-projects-alist
      (list
       (cons "/home/Dropbox/source/site-lisp/"
             (concat "/home/Dropbox/source/site-lisp/etc/git-multi-grep '%s' "
                     "/home/Dropbox/source/site-lisp 'git/*'"))
       (cons "/home/git/ivy-dependencies/"
             (concat "/home/Dropbox/source/site-lisp/etc/git-multi-grep '%s' "
                     "/home/git/ivy-dependencies '*'"))))
